            ...
            if (ModelState.IsValid)
            {
                if (Input.UserType == "Farmer")
                {
                    ...
                    if (farmer != null)
                    {
                        ...
                        var passwordVerificationResult = passwordHasher.VerifyHashedPassword(farmer, farmer.PasswordHash, Input.Password);
                            ...
                            var claims = new List<Claim>
                    {
                        ...
                        new Claim("UserType", Input.UserType)
                            ...
                            await _signInManager.Context.SignInAsync(IdentityConstants.ApplicationScheme, new ClaimsPrincipal(claimsIdentity), authProperties);
